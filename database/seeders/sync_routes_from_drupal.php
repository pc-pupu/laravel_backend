...
$routeMapping = [
    ...
    'existing-occupant-list' => 'existing-occupant.official-with-hrms',
    'existing-occupant-list-draft' => 'existing-occupant.official-draft',
    'existing-occupant-details/%' => 'existing-occupant.details-alias',
    'physical-applicant-details/%' => 'existing-applicant.physical-details',
    'allow-new-application/%' => 'allow-new-application.form',
    'allow-new-application/%/%' => 'allow-new-application.form',
    'physical-application-reject/%' => 'existing-applicant.reject',
    'waiting_list' => 'waiting-list.applicant',
    'view_waiting_list' => 'waiting-list.view',
    'flattype_applicant_vacancy' => 'waiting-list.applicant-vacancy',
    'flat_roaster_details' => 'flat-roaster-details.index',
    'subdivn_rhewise_complaint_list' => 'complaint-management.subdivn-rhewise-list',
    'subdivnwise_no_of_complaint' => 'complaint-management.subdivnwise-count',
    'unauthorized-occupant-list-whrms' => 'unauthorized-occupants.with-hrms',
    'unauthorized-occupant-list-wohrms' => 'unauthorized-occupants.without-hrms',
    'transferred-ddo-list' => 'unauthorized-occupants.transferred-ddo',
    'rhewise_occupantlist' => 'existing-occupant.rhewise-occupantlist',
    'occupant_detail/%' => 'existing-occupant.occupant-detail-alias',
    'rhe_wise_flat_list' => 'update-flat.rhe-wise-list',
