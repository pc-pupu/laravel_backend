...
class UrlEncryptionHelper
{
    ...
    /**
     * Encrypt string without URL encoding (for SSO tokens)
     */
    public static function encryptRaw($string)
    {
        if (empty($string)) {
            return '';
        }
    ...
    /**
     * Decrypt raw string (for SSO tokens)
     */
    public static function decryptRaw($string)
    {
        if (empty($string)) {
            return '';
        }
