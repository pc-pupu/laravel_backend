...
/**
 * Validation for creating a new CMS content entry.
 * Enforces PDF-only upload, size limit, and duplicate (content_title + link_title) check.
 */
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'content_title'        => [
                ...
                'string',
                'max:255',
                Rule::unique('housing_cms', 'content_title')->where('link_title', $this->input('link_title') ?? ''),
            ],
